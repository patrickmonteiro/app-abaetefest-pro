import { defineComponent, ref, shallowRef, watch, h, hasInjectionContext, getCurrentInstance, inject, nextTick, defineAsyncComponent, Suspense, Fragment, useSSRContext, createApp, provide, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope } from 'vue';
...
const _ht = class _ht {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-W7HwWvdr.mjs');
...
const unhead_SVrkJ1LmPONKjtcXYyWUtyfu5cY12D_PJV0zBy9Yhos = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B3L0TYZc.mjs')
  }
];
...
const revive_payload_server_o5f_CJMWU_yM7zEGhOfnrS2lPBqkEMY3GS8epND9RjY = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import('./index-DKcMwzsg.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const plugin_L1bozDJWmIZshP7Y4OdgGCMxiRYRRVZobkgIAq5_y6M = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
    var _a2, _b2;
...
const plugins = [
  unhead_SVrkJ1LmPONKjtcXYyWUtyfu5cY12D_PJV0zBy9Yhos,
  plugin,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DY_dTLQl.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bgx_25lX.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.5_@parcel+watcher@2.5.1_@types+node@24.0.4_db0@0.3.2_eslint@9.29.0_jiti@2.4.2_4e8ac4fc774c6ca9aae786cad9e445e0/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.5_@parcel+watcher@2.5.1_@types+node@24.0.4_db0@0.3.2_eslint@9.29.0_jiti@2.4.2_4e8ac4fc774c6ca9aae786cad9e445e0/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { Icon as I, Yr as Y, Zt as Z, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useHead as d, entry$1 as default, useSeoMeta as e, useAppConfig as f, getIcon as g, asyncDataDefaults as h, createError as i, loadIcon as l, navigateTo as n, resolveRouteObject as r, useRouter as u };
