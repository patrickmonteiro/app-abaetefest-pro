...
const _76F_Lh = defineCachedEventHandler(async (event) => {
...
const _VbCz0Z = lazyEventHandler(() => {
...
const _lazy_LHSCSh = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_LHSCSh, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _76F_Lh, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _VbCz0Z, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_LHSCSh, lazy: true, middleware: false, method: undefined }
];
