...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Aplicação Nuxt 3 com DaisyUI e PWA"},{"name":"theme-color","content":"#ffffff"},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"default"}],"link":[{"rel":"apple-touch-icon","href":"/icons/icon-152x152.png"},{"rel":"mask-icon","href":"/icons/safari-pinned-tab.svg","color":"#ffffff"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"AbaetefestPro"};
