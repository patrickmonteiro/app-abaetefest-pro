...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "b8bcb598-c00f-4cf2-b93b-b746c59f701f",
...
const _nea5wY = defineCachedEventHandler(async (event) => {
...
const _lXsSg_ = lazyEventHandler(() => {
...
const _lazy_UEBIS9 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UEBIS9, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _nea5wY, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _lXsSg_, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UEBIS9, lazy: true, middleware: false, method: undefined }
];
